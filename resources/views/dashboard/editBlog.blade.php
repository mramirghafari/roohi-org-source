                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 text-end d-flex justify-content-end align-items-center">
                                <a href="{{ route('blogAdmin') }}" class="btn btn-secondary">
                                    بازگشت به مقالات
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <form method="POST" action="{{ route('blogPosts.update', $post->id) }}" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                
                                        <div class="card-header">
                                            <h5 class="card-title m-0">ویرایش پست آموزشی</h5>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row mb-3 g-3">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    ...
                                                    <input aria-label="عنوان پست" class="form-control"
                                                           id="title" name="title" placeholder="عنوان پست"
...
<div class="col-12">
    ...
    <input aria-label="اسلاگ" class="form-control" id="slug" name="slug"
        placeholder="مثلاً: laravel-wallet-system" type="text" value="{{ old('slug', $post->slug) }}" />
    @error('slug')
        <small class="text-danger d-block mt-1">{{ $message }}</small>
    @enderror
</div>
...
<div class="col-12">
    ...
    <div class="mt-2">
        @php
            // اگر با storage ذخیره می‌کنی:
            // $coverUrl = $post->cover_image ? asset('storage/'.$post->cover_image) : '';
            // اگر با public_path ذخیره می‌کنی:
            $coverUrl = $post->cover_image ? asset($post->cover_image) : '';
        @endphp

        <img id="coverPreview" src="{{ $coverUrl }}"
