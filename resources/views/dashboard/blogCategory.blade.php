...
<head>
    ...
    <meta content="width=device-width, initial-scale=1.0, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0"
        name="viewport" />
    <title>دسته بندی آموزش: {{ $Category->title }} - روحی بات</title>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="row">
                            <div class="col">
                                <h4 class="py-3 mb-4"><span class="text-muted fw-light">آموزش ها / </span>
                                    {{ $Category->title }}
                                </h4>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-9">
                                @php $access = $Category->access; @endphp

                                @if (isset($accessMessage) && !$canView)
                                    <p class="alert alert-danger my-3">{{ $accessMessage }}</p>
                                @endif
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 mb-3">
                                            <div class="card h-100">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div
                                                        class="d-flex gap-2 position-absolute top-0 start-0 z-index-2 m-4">
                                ...
                                @else
                                    @if ($canView)
                                        <p class="alert alert-info my-3">در حال حاضر مطلبی برای نمایش وجود ندارد.</p>
                                    @endif
                                @endif
                            </div>
