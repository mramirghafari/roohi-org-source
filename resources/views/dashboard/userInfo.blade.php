                      ...
                      <div class="user-profile-info">
                        ...
                        <ul class="list-inline mb-0 d-flex align-items-center flex-wrap justify-content-sm-start justify-content-center gap-2">
                          ...
                          @if ($user->lbank_uid != null)
                            ...
                            <li class="list-inline-item d-flex gap-1"> <i class="ti ti-wallet"></i>موجودی ولت ال بانک: {{ $user->latestBalanceLog?->balance . '$' }}</li>
                          @endif
              ...
              <div class="card mb-2">
                <div class="card-body"> 
                  ...
                  <ul class="list-unstyled mb-4 mt-3">
                    <li class="d-flex align-items-center mb-3"> <i class="ti ti-user text-heading"></i><span class="fw-medium mx-2 text-heading">نام کاربر:</span> <span>{{ $user->nam }}</span>      
                    </li>
        ...
        <div class="card-body">
            <div class="col-12 mt-3">
                    ...
                    <ul class="list-unstyled mb-4 mt-3">
                        ...
                        <li class="d-flex align-items-center mb-3">
                            <input type="text" name="remote_username" class="form-control mb-3"
                                placeholder="نام کاربری" value="{{ old('remote_username', $remoteDesktopAccess->username ?? $user->mobile) }}" />
                        </li>

                        <li class="d-flex align-items-center mb-3">
                            <input type="text" name="remote_password" class="form-control mb-3"
                                placeholder="رمز عبور ریموت" value="{{ old('remote_password', $remoteDesktopAccess?->password ?? $user->mobile) }}" />
                        </li>

                        <li class="d-flex align-items-center mb-3">
                            <input type="number" min="30" max="43200" name="remote_ttl_minutes" class="form-control mb-3"
                                placeholder="مدت اعتبار (دقیقه)" value="{{ old('remote_ttl_minutes', data_get($remoteDesktopAccess, 'meta.ttl_minutes', 43200)) }}" />
                        </li>

                        <li class="d-flex align-items-center mb-3">
                            <select name="remote_profile" class="form-select mb-3">
                                @php
                                    $activeProfile = old('remote_profile', data_get($remoteDesktopAccess, 'meta.desktop_profile', config('remote_desktop.default_profile', 'balanced')));
                                @endphp
                                <option value="lightweight" {{ $activeProfile === 'lightweight' ? 'selected' : '' }}>سبک (حداقل منابع)</option>
                                <option value="balanced" {{ $activeProfile === 'balanced' ? 'selected' : '' }}>متعادل (پیشنهادی)</option>
                                <option value="performance" {{ $activeProfile === 'performance' ? 'selected' : '' }}>قدرتی (برای فشار کاری بیشتر)</option>
                            </select>
                        </li>
                        ...
                        <li class="d-flex align-items-center mb-3">
                            <select name="remote_status" class="form-select mb-3">
                                ...
                                <option value="1" {{ (string) old('remote_status', (int) ($remoteDesktopAccess->is_enabled ?? 0)) === '1' ? 'selected' : '' }}>فعال</option>
                                <option value="0" {{ (string) old('remote_status', (int) ($remoteDesktopAccess->is_enabled ?? 0)) === '0' ? 'selected' : '' }}>غیرفعال</option>
                            </select>
                        </li>

                        <li class="d-flex align-items-center mb-3">
                            <input type="number" step="0.1" min="0.5" max="4" name="remote_cpus" class="form-control mb-3"
                                placeholder="CPU اختصاصی (اختیاری - مثلا 1.2)" value="{{ old('remote_cpus', data_get($remoteDesktopAccess, 'meta.resource_overrides.cpus')) }}" />
                        </li>

                        <li class="d-flex align-items-center mb-3">
                            <input type="number" min="768" max="4096" name="remote_memory_mb" class="form-control mb-3"
                                placeholder="RAM به MB (اختیاری - مثلا 1536)" value="{{ old('remote_memory_mb', data_get($remoteDesktopAccess, 'meta.resource_overrides.memory_mb')) }}" />
                        </li>

                        <li class="d-flex align-items-center mb-3">
                            <input type="number" min="1024" max="6144" name="remote_memory_swap_mb" class="form-control mb-3"
                                placeholder="Swap به MB (اختیاری - مثلا 2048)" value="{{ old('remote_memory_swap_mb', data_get($remoteDesktopAccess, 'meta.resource_overrides.memory_swap_mb')) }}" />
                        </li>

                        <li class="d-flex align-items-center mb-3">
                            <input type="number" min="128" max="1024" name="remote_shm_mb" class="form-control mb-3"
                                placeholder="Shared memory MB (اختیاری - مثلا 256)" value="{{ old('remote_shm_mb', data_get($remoteDesktopAccess, 'meta.resource_overrides.shm_mb')) }}" />
                        </li>

                        <li class="d-flex align-items-center mb-3">
                            <input type="number" min="128" max="1024" name="remote_pids_limit" class="form-control mb-3"
                                placeholder="PID limit (اختیاری - مثلا 256)" value="{{ old('remote_pids_limit', data_get($remoteDesktopAccess, 'meta.resource_overrides.pids_limit')) }}" />
                        </li>
                        ...
                        <li class="d-flex align-items-center mb-3">
                            <p class="alert alert-info col-12">الان هر کاربر بر اساس پروفایل انتخابی کانتینر جداگانه می‌گیرد. اگر فیلدهای CPU/RAM/Swap/SHM را پر کنی، همان کاربر override اختصاصی می‌گیرد. کنترل واقعی منابع فعلاً per-user است؛ per-app واقعی نیاز به اجرای جداگانه هر برنامه در کانتینر مستقل دارد.
                            </p>
                        </li>
                    </ul>
                ...
                @if (session('issued_urls'))
                    <a href="{{ session('issued_urls') }}" target="_blank" class="alert alert-success d-block text-center">لینک اختصاصی دسترسی کاربر</a>
                @endif
                ...
                <div class="card border mt-3 mb-3" id="remote-live-box"
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <a class="btn btn-sm btn-label-primary" href="{{ route('admin.remote.stats.monitor', $user->id) }}" target="_blank">نمایش مانیتور realtime</a>
                        </div>

                        <div id="remote-live-state" class="alert alert-secondary py-2 px-3 mb-3">در حال دریافت داده...</div>
                        ...
                        <div class="mb-2">
                            ...
                            <div class="progress" style="height:8px;">
                                <div id="remote-live-cpu-bar" class="progress-bar bg-primary" role="progressbar" style="width:0%"></div>
                            </div>
                        </div>
                        ...
                        <div class="mb-2">
                            ...
                            <div class="progress" style="height:8px;">
                                <div id="remote-live-mem-bar" class="progress-bar bg-warning" role="progressbar" style="width:0%"></div>
                            </div>
                        </div>

                        <div class="row g-2 mt-1">
                            <div class="col-6"><small class="text-muted">Network:</small> <small id="remote-live-net">-</small></div>
                            <div class="col-6"><small class="text-muted">PIDs:</small> <small id="remote-live-pids">-</small></div>
                            <div class="col-12"><small class="text-muted">Container:</small> <small id="remote-live-container">-</small></div>
                            <div class="col-12"><small class="text-muted">آخرین بروزرسانی:</small> <small id="remote-live-updated">-</small></div>
                        </div>
                    </div>
                </div>
                ...
                <ul class="list-unstyled mb-4 mt-3">
                    ...
                    <li class="d-flex align-items-center mb-3">
                        <span class="badge bg-label-{{ $remoteDesktopAccess->is_enabled ?? false ? 'success' : 'secondary' }}">
                ...
                <ul class="nav nav-tabs mx-3" role="tablist">
                    <li class="nav-item">
                        <button aria-controls="navs-top-profile" aria-selected="true" class="nav-link active"
                            data-bs-target="#subscribe-history" data-bs-toggle="tab" role="tab" type="button">
                    ...
                    <li class="nav-item">
                        <button aria-controls="navs-top-messages" aria-selected="false" class="nav-link"
                            data-bs-target="#navs-top-messages" data-bs-toggle="tab" role="tab" type="button">
                            زیرمجموعه ها
                        </button>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <button aria-controls="user-permissions" aria-selected="false" class="nav-link"
                            data-bs-target="#user-permissions" data-bs-toggle="tab" role="tab" type="button">
                           اعطای دسترسی
                        </button>
                    </li>
                </ul>
            ...
            <form method="POST" action="{{ route('user.UpdateUserInfo', $user->id) }}">
                ...
                <div class="row">
                    <select class="form-select mb-3" name="vip">
                        ...
                        <option value="5" {{ $user->active_subscribe?->vip == 5 ? 'selected' : '' }}>اشتراک 5
                            روزه
                        </option>
                        <option value="10" {{ $user->active_subscribe?->vip == 10 ? 'selected' : '' }}>اشتراک
                            10 روزه
                        </option>
                        <option value="30" {{ $user->active_subscribe?->vip == 30 ? 'selected' : '' }}>اشتراک
                            30 روزه
                        </option>
                        <option value="60" {{ $user->active_subscribe?->vip == 60 ? 'selected' : '' }}>اشتراک
                            60 روزه
                        </option>
                        <option value="90" {{ $user->active_subscribe?->vip == 90 ? 'selected' : '' }}>اشتراک
                            90 روزه
                        </option>
                        <option value="000" {{ $user->active_subscribe?->vip == 0 ? 'selected' : '' }}>لغو
                            اشتراک
                            (مرجوعی)</option>
                    </select>
                    ...
                    <div class="col-12 mb-3">
                        <button type="submit" class="btn btn-success d-block w-100">بروزرسانی اشتراک</button>
                    </div>
                </div>
                ...
                @if ($subscribes && $subscribes->count() > 0)
                    @foreach ($subscribes as $subscribe)
                        <tr>
                            <td>{{ $x++ }}</td>
                            <td>
                                <span class="badge bg-label-primary">{{ $subscribe->vip }} روز</span>
                            </td>
                            <td>
                            ...
                            <td>
                                @if ($subscribe->method)
                                    <span class="badge bg-label-secondary">{{ $subscribe->method }}</span>
                                @else
...
<tr>
    ...
    <div class="tab-pane fade" id="navs-top-messages" role="tabpanel">
        ...
        <p class="mb-0"> لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از
    ...
    <div class="tab-pane fade" id="user-notifs" role="tabpanel">
        <form method="POST" action="{{ route('users.sendNotif', $user->id) }}">
            <div class="row mb-3">
                <div class="col">
                    <input type="text" class="form-control" placeholder="تیتر اعلان" name="title" />
                </div>
            </div>
            <div class="row mb-3">
                <div class="col">
            ...
            <div class="row mb-3">
                <div class="col">
                    <button type="submit" class="btn btn-primary d-block w-100 mt-3">ارسال اعلان</button>
                </div>
            </div>
        </form>
            ...
            @foreach ($notifications as $notification)
                <div class="list-group notif_item bg-white my-1">
                    <a class="list-group-item list-group-item-action d-flex align-items-center p-3 {{ $notification->status == 1 ? 'read' : 'unread' }}"
                        data-notif-id="{{ $notification->id }}" data-notif-modal="notif{{ $notification->id }}"
                        type="button">
                ...
                <!-- Modal -->
                <div aria-hidden="true" class="modal fade" id="notif{{ $notification->id }}" tabindex="-1">
                    ...
                    @if ($tickets && $tickets->count() > 0)
                        @foreach ($tickets as $ticket)
                            <tr>
                                <td>{{ $ticketRow++ }}</td>
                                <td>
                                    <span class="badge bg-label-primary">{{ $ticket->tracking_code ?? '-' }}</span>
                                </td>
                                <td>
                                    <a href="{{ route('support.tickets.show', $ticket->id) }}" target="_blank"
                                ...
                                <td>{{ \App\Models\Ticket::PRIORITIES[$ticket->priority] ?? $ticket->priority }}</td>
                                <td>
                                    <span
                                ...
                                <td>{{ $ticket->assignee?->nam ?? ($ticket->assignee?->name ?? '-') }}</td>
                                <td>
            ...
            <div class="col-12 col-lg-8 mb-3">
                <div class="card border">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('user.wallet.update', $user->id) }}">
                            @csrf
                            <div class="row g-3">
                                <div class="col-12 col-md-4">
                                    ...
                                    <select class="form-select" name="operation" required>
                                        <option value="deposit"
                                            {{ old('operation') === 'deposit' ? 'selected' : '' }}>واریز</option>
                                        <option value="withdraw"
                                            {{ old('operation') === 'withdraw' ? 'selected' : '' }}>کسر</option>
                                    </select>
                                </div>
                                <div class="col-12 col-md-4">
                                    <label class="form-label">نوع کیف پول</label>
                                    <select class="form-select" name="asset" required>
                                        <option value="toman" {{ old('asset') === 'toman' ? 'selected' : '' }}>تومان
                                        </option>
                                        <option value="usdt" {{ old('asset') === 'usdt' ? 'selected' : '' }}>تتر
                                        </option>
                                        <option value="stars" {{ old('asset') === 'stars' ? 'selected' : '' }}>STARS
                                        </option>
                                    </select>
                                </div>
                                <div class="col-12 col-md-4">
                                    <label class="form-label">مقدار</label>
                                    <input type="text" id="wallet-amount-display" class="form-control"
                                ...
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary">ثبت تراکنش و ارسال نوتیف به
                                        کاربر</button>
                                </div>
                            </div>
                        </form>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    @forelse ($walletTransactions as $index => $transaction)
                                        <tr>
                                            <td>{{ $index + 1 }}</td>
                                            <td>{{ $walletTypeLabels[$transaction->type] ?? $transaction->type }}</td>
                                            <td>{{ $walletAssetLabels[$transaction->asset] ?? $transaction->asset }}
                                            </td>
                                            <td><bdi>{{ number_format((float) $transaction->amount, 0) }}</bdi></td>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="8" class="text-center text-muted py-4">تراکنشی برای این
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="access_role" required>
                            ...
                            <option value="super_admin"
                                {{ old('access_role', $currentRole) === 'super_admin' ? 'selected' : '' }}>مدیر کل
                            </option>
                            <option value="support_admin"
                                {{ old('access_role', $currentRole) === 'support_admin' ? 'selected' : '' }}>ادمین
                                پشتیبانی</option>
                            <option value="normal_user"
                                {{ old('access_role', $currentRole) === 'normal_user' ? 'selected' : '' }}>کاربر
                                معمولی
                            </option>
                        </select>
                    </div>

                    <button type="submit" class="btn btn-primary">ذخیره سطح دسترسی</button>
                </form>
                        ...
                        <div class="table-responsive text-nowrap">
                            <table class="table">
                                ...
                                <tbody>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <a href="{{ route('user-groups.show', $group->id) }}"
                                                        class="btn btn-sm btn-label-info">جزئیات گروه</a>
                                                    <form method="POST"
                                                        action="{{ route('user.groups.remove', [$user->id, $group->id]) }}">
                                                        @csrf
                                                        <button type="submit" class="btn btn-sm btn-label-danger">حذف
                                                            از گروه</button>
                                                    </form>
                                                </div>
                                            </td>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="3" class="text-center text-muted py-4">این کاربر در هیچ
                                                گروهی عضو نیست</td>
                                        </tr>
                                    @endforelse
                                </tbody>
