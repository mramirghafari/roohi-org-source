            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse" id="navbarCollapse">
                    <ul class="navbar-nav navbar-nav-scroll dropdown-hover mx-auto">
                        ...
                        <!-- Nav item -->
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ route('contact') }}">تماس با ما</a>
                        </li>
                    </ul>
                </div>
                <!-- Main navbar END -->
...
Hero START -->
        <section class="bg-dark position-relative overflow-hidden pt-xl-8" data-bs-theme="dark">
            ...
            <div class="container position-relative pt-4 pt-sm-5">
                <!-- Title and content -->
                <span class="h2">👋</span>
                <h1 class="display-5 mt-3">تماس با تیم روحی ترید</h1>

                <p class="mb-1">ما اینجا هستیم تا کمک کنیم</p>
                <p>ساعات پشتیبانی: <span class="text-primary fw-bold">۲۴/۷</span></p>
            </div>
        </section>
        <!-- =======================
Hero END -->
                ...
                <div class="row g-4 g-lg-5">
                    ...
                    <div class="col-md-4">
                        <div class="card bg-secondary rounded-4 p-4 h-100">
                            ...
                            <div class="card-body p-0">
                                ...
                                <p class="mb-0">
                                    تماس تلفنی، یا روی تمام پیام رسان های داخلی و خارجی
                                </p>
                            </div>
                            <!-- Card footer -->
                            <div class="card-footer bg-transparent p-0 pt-3">
                                <a href="tel:+9809198259059" class="text-primary-grad d-inline-block"
                                    style="direction: ltr;">+9809198259059</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-secondary rounded-4 p-4 h-100">
                            ...
                            <div class="card-body p-0">
                                <!-- Icon -->
                                <div class="icon-lg bg-primary text-white rounded-circle mb-3">
                                ...
                                <p class="mb-0">
                                    در سریع ترین زمان ممکن در تلگرام پاسخگوی شما هستیم
                                </p>
                            </div>
                            <!-- Card footer -->
                            <div class="card-footer bg-transparent p-0 pt-3">
                                <a href="https://t.me/Aisupport_roohi" class="text-primary-grad">@Aisupport_roohi</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-secondary rounded-4 p-4 h-100">
                            ...
                            <div class="card-body p-0">
                                ...
                                <h6>کانال اطلاع رسانی تلگرام</h6>
                                <p class="mb-0">
                                    برای دریافت آخرین اخبار و اطلاعات تیم ما از طریق کانال تلگرام باخبر شوید...
                                </p>
                            </div>
                            <!-- Card footer -->
                            <div class="card-footer bg-transparent p-0 pt-3">
                                <a class="btn btn-sm btn-white-shadow icon-link icon-link-hover"
                                    href="https://t.me/ecoroohi"><i class="bi bi-arrow-left"></i>عضویت در کانال تلگرام
                                    روحی ترید
                                </a>
                            </div>
                        </div>
